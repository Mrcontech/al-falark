    ...
    <section className="relative min-h-screen flex flex-col justify-end overflow-hidden">
      ...
      <div className="relative z-10 w-full px-6 lg:px-8 pb-12 lg:pb-16 pt-32 lg:pt-40 max-w-7xl mx-auto flex flex-col justify-end">
        <div className="mb-6 lg:mb-8">
          <span className="text-novarc-accent text-[11px] lg:text-[12px] uppercase tracking-[0.5em] font-bold">The Royal Office</span>
        </div>
        <h1 className="text-white text-5xl md:text-7xl lg:text-8xl font-light leading-[1.1] mb-10 lg:mb-14 tracking-tight">
          A Legacy of <br />
          <span className="italic font-serif text-novarc-accent">Visionary</span> Capital
        </h1>
          ...
          <div className="lg:col-span-5 hidden md:block">
            <div className="glass-card p-6 lg:p-8 rounded-sm flex gap-5 lg:gap-6 text-white border-l-4 border-l-novarc-accent">
              ...
              <div className="flex-1">
                <h3 className="text-[13px] font-bold mb-2 tracking-wide text-novarc-accent uppercase">Global Reach, Sovereign Spirit</h3>
                <p className="text-[11px] text-white/60 leading-relaxed">Pioneering investments in sustainable cities, AI-driven infrastructure, and space exploration for the benefit of generations to come.</p>
              </div>
            </div>
          </div>
